 ...
 */
@JtComponent
public class ListenHaveGraspedMapper extends HaveGraspedMapper
{
	@IocAutowire
	public ListenHaveGraspedMapper(MyDatabaseHelper myDatabaseHelper)
	{
	...
	{
		return DatabaseConstants.TABLE_NAME_2;
	}
}
