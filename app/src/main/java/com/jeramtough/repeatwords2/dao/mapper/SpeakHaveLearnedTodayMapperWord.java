 ...
 */
@JtComponent
public class SpeakHaveLearnedTodayMapperWord extends HaveLearnedTodayMapperWord {

    @IocAutowire
    public SpeakHaveLearnedTodayMapperWord(MyDatabaseHelper myDatabaseHelper) {
