 ...
 */
@JtComponent
public class WriteHaveLearnedTodayMapperWord extends HaveLearnedTodayMapperWord {

    @IocAutowire
    public WriteHaveLearnedTodayMapperWord(MyDatabaseHelper myDatabaseHelper) {
