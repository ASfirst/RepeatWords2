 ...
 */
@JtComponent
public class WriteDesertedLearningMapperWord extends DesertedLearningMapperWord
{
	@IocAutowire
	public WriteDesertedLearningMapperWord(MyDatabaseHelper myDatabaseHelper)
	{
