 ...
 */
@JtComponent
public class SpeakMarkedMapperWord extends MarkedMapperWord
{
	@IocAutowire
	public SpeakMarkedMapperWord(MyDatabaseHelper myDatabaseHelper)
	{
	...
	{
		return DatabaseConstants.TABLE_NAME_B_2;
	}
}
