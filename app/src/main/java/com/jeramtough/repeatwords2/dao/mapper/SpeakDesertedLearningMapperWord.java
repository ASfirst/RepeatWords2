 ...
 */
@JtComponent
public class SpeakDesertedLearningMapperWord extends DesertedLearningMapperWord
{
	@IocAutowire
	public SpeakDesertedLearningMapperWord(MyDatabaseHelper myDatabaseHelper)
	{
	...
	{
		return DatabaseConstants.TABLE_NAME_B_4;
	}
}
