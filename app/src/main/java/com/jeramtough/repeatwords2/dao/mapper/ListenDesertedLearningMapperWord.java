 ...
 */
@JtComponent
public class ListenDesertedLearningMapperWord extends DesertedLearningMapperWord
{
	@IocAutowire
	public ListenDesertedLearningMapperWord(MyDatabaseHelper myDatabaseHelper)
	{
	...
	{
		return DatabaseConstants.TABLE_NAME_A_4;
	}
}
