 ...
 */
public class WriteFromMemoryDialog extends JtIocDialog implements TextWatcher, View.OnClickListener {
    ...
    public WriteFromMemoryDialog(@NonNull Context context, Word word) {
        super(context);
        this.word = word;
        ...
        textViewWordInfo.setText(word.getCh());
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        if (!isForgot) {
            if (s.toString().equals(word.getEn())) {
    ...
    public void onClick(View v) {
        if (v.getId() == buttonEn.getId()) {
            ...
            char[] words = word.getEn().toCharArray();
            String htmlCode = "";
